    ...
    <div className='pc-container'>
      ...
      <div className='nav-content align-self-center'>
          ...
          <div className= "nav-item dropdown">
              <p className="tab dropdown-toggle " href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" id = {`${selectedIndex === 1 ? "Item-1" : ""}`} onClick={() => setSelectedIndex(1)}>Categories</p>
